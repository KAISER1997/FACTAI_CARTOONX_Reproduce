...
def main(imgdir, logdir, tensorboard, resize_images):
    ...
    with open(os.path.join(sys.path[0], "../hparams/figure8c/hparams_1.yaml")) as f:
    ...
    # Log the figure8c file to check later what figure8c were used
    copyfile(os.path.join(sys.path[0], "../hparams/figure8c/hparams_1.yaml"), os.path.join(logdir,
                                                                                           "../hparams/figure8c/hparams_1.yaml"))
