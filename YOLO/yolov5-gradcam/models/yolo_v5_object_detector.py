...
#             print("test1",log_.shape,xc.shape,prediction.shape)
            # Apply constraints
            # x[((x[..., 2:4] < min_wh) | (x[..., 2:4] > max_wh)).any(1), 4] = 0  # width-height
            x = x[xc[xi]]  # confidence
            log_ = log_[xc[xi]]
#             print("test2",log_.shape)
...
#         print(len(logits),logits[0].shape,"dragoness")
        ...
        return [self.boxes, self.classes, self.class_names, self.confidences], logits,old_logits.permute(0,2,1),"dragon"
